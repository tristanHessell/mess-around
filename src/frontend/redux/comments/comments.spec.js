...
import { commentChangesSelector } from './selectors';
import {
  getCommentsRequest,
  getCommentsSuccess,
  saveCommentsRequest,
...
describe('Redux: comments', () => {
  describe('Action Creators', () => {
    it('creates an action to show getting comments in progress', async () => {
      ...
      expect(getCommentsRequest('playlistId', 'requestId')).toEqual(
        expectedAction,
      );
    });
  ...
  describe('Custom', () => {
    describe('commentChangesSelector', () => {
      ...
      it('should return empty comment if there is none for specifed id', async () => {
        ...
        expect(selector('songId')).toEqual({
          comment: undefined,
          hasChanged: false,
        });
      });
